...
<##>
$gitVariables=@{};
$gitVariables=$(git config --list)|ForEach-Object { 
    $parts=$($_).ToString().Trim().Split("=");  
    $gitVariables["$($parts[0])"]="$($parts[-1])" 
}; 

#$gitVariables['remote.origin.url']
#throw "FAIL"
exit 0

#region https://doitpsway.com/automation-of-your-git-repository-via-git-hooks-and-powershell-scripts
<#
...
notify user about:
    ...
    "DONE"
#endregion https://doitpsway.com/automation-of-your-git-repository-via-git-hooks-and-powershell-scripts
